...
(function () {
  ...
  // --------------------------------------------------------------
  // Part 2 from https://ychaikin.github.io/jhu-ajax-course/Module4
  // --------------------------------------------------------------
  var speakPart2 = function(str) {
    var firstLetter = str.charAt(0).toLowerCase();
    if (firstLetter == 'j') {
      return byeSpeaker.speakSimple(str);
    } else {
      return helloSpeaker.speakSimple(str);
    }
  }

  console.log("\n--------------------------------------------------------------");
  names.map(name => console.log(speakPart2(name)));
